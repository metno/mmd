        ...
        <xsl:element name="gmd:MD_DataIdentification">
          ...
          <xsl:element name="gmd:resourceConstraints">
            <xsl:element name="gmd:MD_LegalConstraints">
              ...
              <!--FIXME access_constraint is not parsed from thredds. Making some hardcoded assumptions. This is
              mandatory, but we cannot map to any limitations from the inspire controlled vocabulary-->
            ...
            <xsl:element name="gmd:MD_LegalConstraints">
              ...
              <xsl:choose>
                <xsl:when test="mmd:use_constraint/mmd:resource != ''">
                  <xsl:element name="gmd:otherConstraints">
                    <xsl:element name="gmx:Anchor">
                      <xsl:variable name="license" select="mmd:use_constraint/mmd:identifier"/>
                      <xsl:attribute name="xlink:href">
