...
|personnel/type
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:individualName +
or +
/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:organisationName
| use gmd:individualName for type "Person" and gmd:organisationName for type "Organisation"

|personnel/name (M)
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:individualName/gco:CharacterString or gmx:Anchor +
or +
/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:organisationName/gco:CharacterString or gmx:Anchor
|see personnel/type above to discriminate between gmd:individualName and gmd:organisationName.
See also personnel/name @uri below to discriminate between gco:CharacterString and gmx:Anchor

|personnel/name @uri
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:individualName/gmx:Anchor +
or +
...
|name can be presented as gmx:Anchor instead of gco:CharacterString: <gmx:Anchor xlink:href="@uri">name</gmx:Anchor>
...
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:organisationName/gco:CharacterString or gmx:Anchor
|see personnel/organisation @uri below to discriminate between gco:CharacterString and gmx:Anchor

|personnel/organisation @uri
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact/gmd:CI_ResponsibleParty/gmd:organisationName/gmx:Anchor
|
...
|MMD type is mapped to ISO gmd:protocol and gmd:function codeListValue. See xref:MMD-ISOInspire_vocabulary_mapping.adoc[vocabulary mapping file].
...
|gmx:Anchor can also be used instead of gco:CharacterString. For GCMDKS, NORTHEMES, GEMET and CFSTDN use /gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:type/gmd:MD_KeywordTypeCode with codeListValue="theme". For GCMDPLT and GCMDINST use "platform" and "instrument" respectively.

|keywords/keyword
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword/gco:CharacterString
|gmx:Anchor can also be used instead of gco:CharacterString (see keywords/resource)
...
|project/long_name
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword/gco:CharacterString
|gmx:Anchor can also be used instead of gco:CharacterString. Use /gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:type/gmd:MD_KeywordTypeCode with codeListValue="project"
...
|platform/long_name
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword/gco:CharacterString
|gmx:Anchor can also be used instead of gco:CharacterString. Use /gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:type/gmd:MD_KeywordTypeCode with codeListValue="platform"
...
|/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword/gco:CharacterString
|gmx:Anchor can also be used instead of gco:CharacterString. Use /gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:type/gmd:MD_KeywordTypeCode with codeListValue="instrument"
