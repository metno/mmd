...
Øystein{nbsp}Godøy, Trygve{nbsp}Halsne, Øystein{nbsp}Torget, Bard{nbsp}Saadatnejad, Egil{nbsp}Støren, Sarfraz{nbsp}Alam
Version 2.2 (draft)
:doctype: book
...
|2.2 |2019-10-?? |Several minor modifications has not been document.
Collecting these and preparing for transition into ASCIDOC like
CF-conventions. |Øystein Godøy
