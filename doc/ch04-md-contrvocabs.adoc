...
|CSAR       |Synthetic Aperture Radar C-band             | https://www.wmo-sat.info/oscar/instruments/view/450
|MSI        |Multi-Spectral Imager                       | https://www.wmo-sat.info/oscar/instruments/view/312
